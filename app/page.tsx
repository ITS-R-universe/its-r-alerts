...
<h1 style={{fontSize:'2.5rem',fontWeight:'bold',textAlign:'center'}}><span style={{color:'#d4af37'}}>ITS-R</span> Alerts</h1>
<p style={{color:'#94a3b8',textAlign:'center',marginTop:'1rem'}}>Utility Tools — ITS-R Universe</p>
